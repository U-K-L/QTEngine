...
C:/VulkanSDK/1.3.290.0/Bin/dxc.exe dxc -T ps_6_0 -E main -spirv Background/albedo_frag.hlsl -Fo albedoFrag.spv
C:/VulkanSDK/1.3.290.0/Bin/dxc.exe dxc -T vs_6_0 -E main -spirv Background/albedo_vert.hlsl -Fo albedoVert.spv
